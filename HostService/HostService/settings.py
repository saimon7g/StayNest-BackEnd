"""
Django settings for HostService project.
...
SECRET_KEY = 'django-insecure-39tiadkx@01vg7jw5ij_9x8h)%n%f5x#1d)3-q4x6^t7hy5y&-'
...
WSGI_APPLICATION = 'HostService.wsgi.application'
